 ...
 ## O que aconteceu?
 Uma alteração "simples" de código aumentou levemente o consumo de memória,  causando OOMKill em Pods que não tinham limites adequados nem probes  configuradas.
